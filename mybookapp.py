...
SMALLBOOKS = [
    SmallBook(1, "Godan"),
    SmallBook(2, "kamayani"),
    SmallBook(3, "Hindi Sahitya Ka Itihas"),
    SmallBook(4, "Rajtarangini"),
    SmallBook(5, "Mansarovar"),
]
...
async def get_all_books():
    return [ book.title for book in SMALLBOOKS ]
    #return BOOKS
